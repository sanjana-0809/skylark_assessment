...
Try it yourself: **[Hugging Face Spaces demo](PASTE_HF_LINK_HERE)** *(coming soon)*

Upload any aerial image with a GCP marker and see the model's prediction in real time.
